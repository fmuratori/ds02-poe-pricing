'''
This script produces two files named X.pkl and y.pkl
containing respectively all the features generated and the
dependant varible to predict.
'''
import os
import click
import types
...
DATA_CATEGORY = 'weapons'
CURRENCY_TYPES = ['chaos', 'exalted']
TRAIN_SPLIT = 0.8

# Features generation configuration
CHUNK_SIZE = 10000
FEATURES_X = [(features.IsAbyssJewel, {}),
              (features.IsSynthesised, {}),
              (features.IsCorrupted, {}),
              (features.IsDuplicated, {}),
              (features.IsIdentified, {}),
              (features.IsVeiled, {}),
              (features.NumPrefixes, {}),
              (features.NumSuffixes, {}),
              (features.NumVeiledMods, {}),
              (features.Requirements, {}),
              (features.Influences, {}),
              (features.SocketColour, {}),
              (features.SocketsCount, {}),
              (features.SocketsMaxGroupCount, {}),
              (features.Ilvl, {}),
              (features.Modifiers, {}),
              (features.Properties, {}),
              (features.Category, {}),
...
def transform_with_check(l, data, feat):
